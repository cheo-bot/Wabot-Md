...
module.exports = async(conn, msg, m, setting) => {
	try {
		...
		const buttonsDefault = [
			...
			{ quickReplyButton: { displayText: `Grup Jojo`, id: `${prefix}groupjojo` } },
  ...
  reply("Ada apa kak?ada yg bisa Bot Bantu?ketik !menu untuk melihat fitur bot yg tersedia ya kak")
		...
		switch(command) {
			...
			case prefix+'help':
			    ...
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync(setting.pathimg) }, templateButtons: buttonsDefault, footer: 'GhosBid V3.0', mentions: [sender] })
				break
			case prefix+'runtime':
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      ...
			      sendContact(from, "6281319944917", 'Partner Owner', msg)
			      sendContact(from, "6289653381067", 'Partner Owner', msg)
			      sendContact(from, "6285791458996", 'Partner Owner', msg)
			    }
			    textImg("Wtf ngapain")
			    break
			case prefix+'cekprem':
 ...
 Untuk mengambil Audio/Video dari hasil pencarian`
			...
			case prefix+'setnamegrup': case prefix+'setnamegc':
			    ...
			    if (isPremium) {
				  ...
				  conn.sendMessage(from, hn, image, { caption:`kamu user premium jadi kamu mendapatkan foto normal`})
				} else {
				 if (!yuri) return reply(`Fitur yuri sedang di nonaktifkan oleh owner!`)
				  ...
				  conn.sendMessage(from, oa, image, { caption:`kamu user premium jadi kamu mendapatkan foto normal` })
				  limitAdd(sender, limit)
				}
			    break
...
case prefix+'glitch':
  ...
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/glitch?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'neon':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/neon?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'black':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/black?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'fiction':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/fiction?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'blackpink':
  ...
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/bp?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
  ...
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/neonlight?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'toxic':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/toxic?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'matrix':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/matrix?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'neonpl':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/neonpl?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'breakwall':
  ...
  if (args.length < 2) return reply(`Kirim Perintah ${command} Text Mu\nContoh ${command} Jojo`)
  textImg(mess.wait)
  conn.sendMessage(from, { image: { url: `https://melcanz.com/textpro/breakwall?text=${args[1]}&apikey=${apikey}`}})
  limitAdd(sender, limit)
  break
case prefix+'grafity':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
