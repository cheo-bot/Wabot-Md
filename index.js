...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('GhosKyy V3.0 MD', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Recode By Xyan ]')}\n\n${chalk.red('GhosBidd')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('iamghosky_')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 896-5338-1067')}\n${chalk.red('Donate')} : ${chalk.white('089653381067 ( Gopay/Pulsa )')}\n`))
}
