...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Xyann ]')}\n\n${chalk.red('GhosBid V3.0')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@iamghosky_')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 896-5338-1067')}\n${chalk.red('Donate')} : ${chalk.white('089653381067 ( Dana/Ovo/Pulsa )')}\n`))
}
...
function nocache(module, cb = () => { }) {
	console.log(`Module ${module} sedang diperhatikan oleh ketua pki atas perubahanny kalo credit di ubah siap siap jam 3 malam`) 
